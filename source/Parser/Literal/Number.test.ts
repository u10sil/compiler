...
describe("Parser.Expressions.Literal.Number", () => {
	...
	it("typed object", () => {
		...
		expect(SyntaxTree.filterId(literal!.serialize())).toEqual({ class: "literal.typedObject", name: { class: "type.identifier", name: "Class" }, value: { class: "literal.number", value: 12345 } })
	})
})
