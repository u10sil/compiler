...
`
			...
			this.expect(firstField.left.getName(), Is.equal.to("i"))
			this.expect(firstField.type.getName(), Is.equal.to("Int"))
			...
			this.expect(secondField.left.getName(), Is.equal.to("f"))
...
`
			...
			this.expect((<SyntaxTree.Type.Identifier>updateCountArgument.type).getName(), Is.equal.to("Int"))
